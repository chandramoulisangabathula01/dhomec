...
export default function EditCategoryPage() {
  ...
  useEffect(() => {
    const fetchCategory = async () => {
        ...
        if (isDemo) {
            // Mock data lookup
             if (id === '1') setFormData({ name: 'Boom Barriers', slug: 'boom-barriers', description: 'Traffic control barriers' });
             else if (id === '2') setFormData({ name: 'Turnstiles', slug: 'turnstiles', description: 'Pedestrian access' });
             else setFormData({ name: 'Demo Category', slug: 'demo', description: 'Demo Description' });
      ...
      <div className="bg-card rounded-xl shadow-sm border border-border p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
                ...
                />
                <p className="text-xs text-muted-foreground mt-1">Changing this will change the URL of the category page.</p>
            </div>
